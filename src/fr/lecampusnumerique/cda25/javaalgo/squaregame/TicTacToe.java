...
import fr.lecampusnumerique.cda25.javaalgo.squaregame.players.TicTacToePlayer;

public class TicTacToe {

    public View view = new View();
    public InteractionUtilisateur userInter = new Userinteraction();
    ...
    public void getNumberOfPlayer() {
        ...
        if (isNumeric(String.valueOf(nbPlayer)) && nbPlayer >= 0 && nbPlayer <= 2) {
            if (nbPlayer == 0) {
                this.player = new TicTacToePlayer();
                this.player2 = new TicTacToePlayer();
            } else if (nbPlayer == 1) {
